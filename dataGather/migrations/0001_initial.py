# Generated by Django 5.0.3 on 2024-04-09 05:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geotag_images', models.ImageField(upload_to='geotag_images', verbose_name='(*) (geo-tag) آپلود تصویر زمین مرجع   ')),
                ...
                ('feature', models.CharField(choices=[('انتخاب کنید', 'انتخاب کنید'), ('کشاورزی', 'کشاورزی'), ('باغ', 'باغ'), ('مرتع', 'مرتع'), ('سنگ', 'سنگ'), ('خاک', 'خاک'), ('آب', 'آب'), ('جنگل', 'جنگل'), ('پسماند', 'پسماند'), ('آتش', 'آتش'), ('برف', 'برف'), ('زمین\u200cسوخته', 'زمین\u200cسوخته'), ('دود و گاز', 'دود و گاز'), ('هیچکدام', 'هیچکدام')], default='انتخاب کنید', max_length=20, verbose_name='انتخاب گروه عارضه ')),
